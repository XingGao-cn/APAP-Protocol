%plot the smooth traffic load map
...
for i=1:length(node)-1
   ...
   part(index)=part(index)+length(node(i).receive);
    ...
    part2=part./num;
    Bytes=part.*bytes;
    part=interp1(1:length(part),part,1:1:200,'Nearest');
    part2=interp1(1:length(part2),part2,1:1:200,'Nearest');
    Bytes=interp1(1:length(Bytes),Bytes,1:1:200,'Nearest');
    ...
    %异常值处理
     ...
     legend('The APAP scheme of this paper','The PR scheme');
