...
for i=1:3500
   node(901).Data(i).ID=0; 
   node(901).Data(i).PRs=0;
   node(901).Data(i).start_time=0;
   node(901).Data(i).num=0;
   node(901).Data(i).TTL=0;
   node(901).Data(i).delay=0;
   node(901).Data(i).w=1;
end
%通信范围r内全部邻居节点
dist=inf;
