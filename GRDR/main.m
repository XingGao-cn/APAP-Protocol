...
% if q==2
% save('full-round_DRDR,q=2');
% elseif q==3
% save('full-round_GRDR,q=3');
% else
% save('full-round_GRDR,q=4')    
% end
%********保存数据************
if q==2
    if testflag==1
        save('oneRound_GRDR,q=2');
    else
        save('period_GRDR,q=2');
    end
elseif q==3
    if  testflag==1
        save('oneRound_GRDR,q=3');
    else
         save('period_GRDR,q=3');
    end
else
    if testflag==1
        save('oneRound_GRDR,q=4');
    else
        save('period_GRDR,q=4');
    end
end
%**************************
