%main
clear,clc;
%topology;%topology;%Running this line of code will reset the network topology
plot_node;
plot_ring;
...
intercept2=0;
intercept3=0;
[node]=construct_table(node,1,30,20);
[node]=construct_table(node,2,30,20);
[node]=construct_table(node,3,30,20);
die=0;
